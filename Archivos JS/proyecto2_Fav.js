...
facebook.addEventListener("mouseover", ()=> {
    ...
    facebook.setAttribute("src", "../assets/icon-facebook.svg");

})

facebook.addEventListener("mouseout", ()=> {
    facebook.removeAttribute("src");
    facebook.setAttribute("src", "../assets/icon-facebook_hover.svg");
...
verMas.addEventListener("click", ()=> {
    FavoritosComp();    
    console.log(favMostrados.length);
    GrillaFavoritos(3*indexgrilla);     
  })
